...
comp<-function(url.1,url.2,extr.1,extr.2,titulo){
  ...
  tema<-theme(axis.text=element_text(size=15),
...
titulo<-"Pie Izquierda en Reposo"
url.1<-"P7/P7 reposo pies.xlsx"
extremidad.1<-"Izquierda.2"
url.2<-"P46/p46 pies reposo.xlsx"
extremidad.2<-"Izquierda.2"
